...
export default function Home() {
  ...
  <div className="w-full md:max-w-96">
    ...
    <div className="space-y-4 bg-gray-800 px-4 py-3 rounded-lg">
      <div className="space-y-3">
        ...
        <div className="space-y-2 mt-4">
          <button
            ...
            Дополнительно
            <svg
              className={`lucide lucide-chevron-down transition-transform duration-200 ${isOpen2 ? 'rotate-180' : ''}`}
              fill="none"
              height="16"
              id="block"
              stroke="currentColor"
      ...
      {isOpen && (
         <div
         className={`fixed left-[50%] top-[50%] z-50 w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border p-6 shadow-lg duration-200 bg-gray-800 text-white rounded-lg ${isOpen ? 'block' : 'hidden'}`}
         id="modal"
         role="dialog">
